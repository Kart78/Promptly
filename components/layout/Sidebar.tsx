...
export function Sidebar({ memberCount, onlineCount, adminCount, leaderboard, community }: SidebarProps) {
      ...
      <div className="bg-white border border-gray-100 rounded-xl overflow-hidden">
        ...
        <div className="p-4">
          <div className="flex items-center gap-2 mb-3">
            {community?.logoUrl ? (
              <img src={community.logoUrl} alt={name} className="w-8 h-8 rounded-lg object-cover" />
            ) : (
